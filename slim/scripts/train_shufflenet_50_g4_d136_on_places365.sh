...
# 1.
# 2. Trains a shufflenet_50 with 4 groups and 136 base-channel model on the places365 training set.
# 3. Evaluates the model on the places365 testing set.
#
# Usage:
# cd slim
# ./scripts/train_shufflenet_50_g4_d136_on_places365.sh
set -e

# Where the checkpoint and logs will be saved to.
TRAIN_DIR=/home/qianbb/Projects/places365-tf/models/shufflenet_50_g4_d136
