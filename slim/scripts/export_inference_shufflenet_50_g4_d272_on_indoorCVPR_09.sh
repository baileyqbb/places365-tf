...
INFERENCE_GRAPH_PATH=/home/qianbb/PycharmProjects/places365-tf/models-indoorCVPR_09/shufflenet_50_g4_d272/all

# intermedia graph
TMP_GRAPH=shufflenet_50_g4_d272_inf_graph.pb

# final exported graph with trained weights
EXPORT_INF_GRAPH=shufflenet_50_g4_d272_inf_graph_freeze.pb
...
if [ ${reExport+x} ]; then
    python ~/tensorflow/tensorflow/python/tools/freeze_graph.py \
      ...
      --input_checkpoint=${CHECKPOINT_PATH}/model.ckpt-179777 \
      --input_binary=true \
