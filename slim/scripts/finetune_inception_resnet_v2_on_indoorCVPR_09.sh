...
# 
# 2. Fine-tunes a inception-resnet-v2 model on the indoorCVPR_09 training set.
# 3. Evaluates the model on the indoorCVPR_09 validation set.
#
# Usage:
# cd slim
# ./slim/scripts/finetune_resnet_v1_50_on_indoorCVPR_09.sh
set -e

# Where the pre-trained ResNetV1-50 checkpoint is saved to.
PRETRAINED_CHECKPOINT_DIR=/home/qianbb/PycharmProjects/places365-tf/models-places365/inception_resnet_v2/all
